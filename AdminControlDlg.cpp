...
CAdminControlDlg::CAdminControlDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_ADMINCONTROL_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CAdminControlDlg, CDialogEx)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()


// CAdminControlDlg 메시지 처리기
